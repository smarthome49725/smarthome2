...
socket.on('lightBathroom', function (lamp) {   
    if (bathroom == 0 && lamp == "True") {
        sendLampBathroom();
        acenderLampBathroom();        
    } else if (bathroom == 1 && lamp == "False") {
        sendLampBathroom();
        acenderLampBathroom();        
    }
});

socket.on('lightKitchen', function (lamp) {
    if (kitchen == 0 && lamp == "True") {
        sendLampKitchen();
        acenderLampkitchen();        
    } else if (kitchen == 1 && lamp == "False") {
        sendLampKitchen();
        acenderLampkitchen();        
    }
});
...
socket.on('lightBedroom', function (lamp) {
    if (bedroom == 0 && lamp == "True") {
        sendLampBedroom();
        acenderLampbedroom();
    } else if (bedroom == 1 && lamp == "False") {
        sendLampBedroom();
        acenderLampbedroom();
    }
});
...
socket.on('lightRoom1', function (lamp) {
    if (roomOne == 0 && lamp == "True") {
        sendLampRoomOne();
        acenderLamproomOne();        
    } else if (roomOne == 1 && lamp == "False") {
        sendLampRoomOne();
        acenderLamproomOne();
    }
});
...
socket.on('lightRoom2', function (lamp) {
    if (roomTwo == 0 && lamp == "True") {
        sendLampRoomTwo();
        acenderLamproomTwo();
    } else if (roomTwo == 1 && lamp == "False") {
        sendLampRoomTwo();
        acenderLamproomTwo();
    }
});
...
socket.on('TV', function (tv_on_off) {    
    if (tv == 0 && tv_on_off == "True") {
        sendTvHome();
        activeTvCia();
    } else if (tv == 1 && tv_on_off == "False") {
        sendTvHome();
        activeTvCia();
    }
});
...
socket.on('curtain', function (curtain) { 
    if (statusCurtain == 0 && curtain == "True") {
        sendCurtain();
        activeCurtain();
    } else if (statusCurtain == 1 && curtain == "False") {
        sendCurtain();
        activeCurtain();
    }
});
...
socket.on('air-conditioning', function (air_on_off) {    
    if (ar == 0 && air_on_off == "True") {
        sendArHome();
        activeArCia();
    } else if (ar == 1 && air_on_off == "False") {
        sendArHome();
        activeArCia();
    }
});
