...
client.on('data', function (data) {
    ...
    switch (dataReiceived.code) {
        case "PORT":
            ...
            socket.emit("lightKitchen", userCustom.lightKitchen);
            socket.emit("lightBedroom", userCustom.lightBedroom);
            ...
            if (userCustom.lightKitchen == "True") {
                lightKitchen();
            ...
            if (userCustom.lightBedroom == "True") {
                lightBedroom();
            ...
            if (userCustom.air_conditioning == "True") {
                airConditioning();
                  if (ar.status_ar == 0){
                      airConditioning();
                  }
